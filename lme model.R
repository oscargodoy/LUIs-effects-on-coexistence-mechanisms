#Advice in https://freshbiostats.wordpress.com/2013/07/28/mixed-models-in-r-lme4-nlme-both/
...
for(i in 1:21){
  ...
  mlist[[i]] <- lme(as.formula(paste(yy[i], "~ LUI + LUI*(", paste(top20.short, collapse="+"),"+Rest)","+(0+Yeart|Plot)+(1|Plot)+(1|Year_change)")), data= pchange.all2)
